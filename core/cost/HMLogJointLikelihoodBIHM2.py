...
class HMLogJointLikelihoodBIHM2(AbstractModule):

    def __init__(self, name="HMLJLBIHM"):
    ...
    def _build(self, hm):
        ...
        log_px_unnormalized = (hm.importance_sampling_node_bihm - tf.math.log(tf.cast(n_samples, dtype=tf.float32))) * 2
