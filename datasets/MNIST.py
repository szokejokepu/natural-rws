...
class MNIST(ImageDataset):
    ...
    def __init__(self, params):
        ...
        if self._binary_input == 0:
            default_data_dir = 'dataset_path/MNIST/MNIST_data'
        ...
        # binary mnist
            ...
            default_data_dir = "dataset_path/MNIST/MNIST_raw"
            self.data_dir = self._params['data_dir'] if 'data_dir' in params else default_data_dir
            ...
            self._train_set_x, self._train_set_y, \
            self._validation_set_x, self._validation_set_y, \
            self._test_set_x, self._test_set_y = self.load_binary_mnist(self.data_dir, pm=self._pm_one)
    ...
    @staticmethod
    def load_binary_mnist(data_dir, train_test_ratio=None, pm=False):
